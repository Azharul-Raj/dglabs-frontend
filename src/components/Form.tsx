            ...
            <div className="">
                <form onSubmit={handleSubmit} action="">
                    ...
                    <div className="md:pt-4 md:pb-5 px-4 md:px-12 rounded-bl-lg rounded-br-lg dark:bg-[#252D3C] flex justify-center md:justify-end">
                        <button type='submit' className='flex w-full md:w-auto items-center justify-center bg-blue-600 text-white py-3 px-4 rounded-lg'>{`${btnTitle?btnTitle:`Next`}`} <FiChevronRight /></button>
                    </div>
                </form>
            </div>
        </div>
